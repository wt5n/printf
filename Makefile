...
#    Updated: 2020/02/17 17:27:56 by ksenaida         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC1 = adv_itoa.c ap_arith.c parsing.c ft_printf.c \
	...
	type_f_and_F.c type_str.c type_u.c type_xX_and_o.c type_p.c type_o.c

OBJ1 = adv_itoa.o ap_arith.o parsing.o ft_printf.o \
	length.o type_c.o type_d_and_i.o ft_put_cow.o handling_f.o \
	type_f_and_F.o type_str.o type_u.o type_xX_and_o.o type_p.o type_o.o
